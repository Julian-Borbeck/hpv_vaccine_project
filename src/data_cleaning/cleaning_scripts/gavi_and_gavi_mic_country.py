...
if new_in_mic:
    ...
    # create empty year cols (only 2022–2025 are needed for your MIC overwrite)
    for y in range(MIC_FILL_START_YEAR, MIC_FILL_END_YEAR + 1):
...
# 1) Base: from your already-built `wide`
...
# 2) Prefill tricky codes (your provided list)
prefill_map = {
...
def make_name_to_code(df, label):
    ...
    # keep first code per name (name→code may not be unique; we follow your "keep first" convention)
